...
const plugins = [
    new webpack.DefinePlugin({
        ...
        ETHEREUM_BRIDGE_CUSTODIAL_ACCOUNT: `"${process.env.ETHEREUM_BRIDGE_CUSTODIAL_ACCOUNT || "0.0.60629"}"`,
        ...
        BRIDGE_CONTRACT_ADDRESS: `"${process.env.BRIDGE_CONTRACT_ADDRESS || "0x2Ec869549DC1b192dA08EA1b80FCcCfA904705cA"}"`,
        WHBAR_CONTRACT_ADDRESS: `"${process.env.WHBAR_CONTRACT_ADDRESS || "0x8fdaDe00B6bCEBe5F5B68F4FAb96BFE646909f2b"}"`,
        VALIDATOR_ENDPOINT: `"${process.env.VALIDATOR_ENDPOINT || "http://localhost:6200/api/v1/"}"`,
